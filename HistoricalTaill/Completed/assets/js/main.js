...
// Open menu & search pop-up
    ...
    document.addEventListener('click', function(e) {
        if (!e.composedPath().includes(menuToggleIcon) && !e.composedPath().includes(menu)) {
...
searchIcon.addEventListener('click', function (e) {
    ...
    searchInput.focus(); // Arama kutusuna odaklan
});

// Close search form when clicking outside of it
document.addEventListener('click', function (e) {
    if (!e.composedPath().includes(searchIcon) && !e.composedPath().includes(searchForm)) {
